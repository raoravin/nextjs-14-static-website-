  ...
  return (
    <div className="max-sm:px-4 px-10">
      <h1 className="color_2 text-2xl max-sm:text-base max-md:text-lg max-lg:text-xl font-medium">
          ...
          <p className=" text-white text-pretty text-5xl max-sm:text-lg max-md:text-xl max-lg:text-2xl font-semibold max-sm:my-2 my-5">
      ...
      >
        ...
        {slides.map((slide, index) => (
          ...
          >
            <div className=" py-0 xl:py-5 text-lg md:text-2xl lg:text-3xl xl:text-4xl">{slide.icon}</div>
            <div className="">
              <p className="text-xs sm:text-base md:text-lg lg:text-xl xl:text-2xl 2xl:text-2 max-sm:pt-1 py-0 sm:py-8 xl:py-10">{slide.text}</p>
